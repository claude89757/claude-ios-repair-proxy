...
const I18N = {
  zh: {
    ...
    "disclaimer.kicker": "使用边界",
    "disclaimer.title": "免责声明与使用边界",
  ...
  en: {
    ...
    "disclaimer.kicker": "Usage boundaries",
    "disclaimer.title": "Disclaimer and usage boundaries",
